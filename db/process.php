...
if($type == 'new')
{
	...
	$date = date("Y-m-d");
	$insert = mysqli_query($con,"INSERT INTO calendar(`title`, `startdate`, `enddate`, `allDay`, `dateStamp`) VALUES('$title','$startdate','$startdate','true', '$date')"); //change to true to toggle all day default events
